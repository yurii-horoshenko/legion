...
description: Use this agent when distributed system errors occur and need coordinated handling across multiple components, or when you need to implement comprehensive error recovery strategies with automated…
color: "#4dd039"
emoji: ⚙️
vibe: Distributed system errors occur and need coordinated handling across multiple components…
---
