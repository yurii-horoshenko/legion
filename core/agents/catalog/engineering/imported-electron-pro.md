---
name: Electron Pro
description: Use this agent when building Electron desktop applications that require native OS integration, cross-platform distribution, security hardening, and performance optimization. Use electron-pro for…
color: "#d07339"
emoji: ⚙️
vibe: Building Electron desktop applications that require native OS integration, cross-platform…
---
