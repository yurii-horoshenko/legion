---
name: Agent Creator
description: Use this agent when the user asks to "create an agent", "generate an agent", "build a new agent", "make me an agent that...", or describes agent functionality they need. Trigger when user wants to…
color: "#d07839"
emoji: ⚙️
vibe: The user asks to "create an agent", "generate an agent", "build a new agent", "make me an…
---
