...
description: Expert in event sourcing, CQRS, and event-driven architecture patterns. Masters event store design, projection building, saga orchestration, and eventual consistency patterns. Use PROACTIVELY for…
color: "#3996d0"
emoji: ⚙️
vibe: Expert in event sourcing, CQRS, and event-driven architecture patterns.
---
