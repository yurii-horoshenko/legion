...
description: Elite bug-fixing agent that enriches task context from Monday.com platform data. Gathers related items, docs, comments, epics, and requirements to deliver production-quality fixes with comprehensive…
color: "#c139d0"
emoji: ⚙️
vibe: Elite bug-fixing agent that enriches task context from Monday.com platform data.
---
