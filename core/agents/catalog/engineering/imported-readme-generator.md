...
description: Use this agent when you need a maintainer-ready README built from exact repository reality, with deep codebase scanning, zero hallucination, and optional git commit/push only when explicitly…
color: "#399bd0"
emoji: ⚙️
vibe: You need a maintainer-ready README built from exact repository reality, with deep…
---
