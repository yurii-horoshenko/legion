...
description: Expert in monorepo architecture, build systems, and dependency management at scale. Masters Nx, Turborepo, Bazel, and Lerna for efficient multi-project development. Use PROACTIVELY for monorepo…
color: "#d039ad"
emoji: ⚙️
vibe: Expert in monorepo architecture, build systems, and dependency management at scale.
---
