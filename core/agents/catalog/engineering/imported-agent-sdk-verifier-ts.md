...
description: Use this agent to verify that a TypeScript Agent SDK application is properly configured, follows SDK best practices and documentation recommendations, and is ready for deployment or testing. This…
color: "#39d0b2"
emoji: ⚙️
vibe: Verify that a TypeScript Agent SDK application is properly configured, follows SDK best…
---
