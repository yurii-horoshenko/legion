...
description: Expert Terraform/OpenTofu specialist mastering advanced IaC automation, state management, and enterprise infrastructure patterns. Handles complex module design, multi-cloud deployments, GitOps…
color: "#39d096"
emoji: ⚙️
vibe: Expert Terraform/OpenTofu specialist mastering advanced IaC automation, state management…
---
