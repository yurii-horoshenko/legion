---
name: Rust Engineer
description: Use when building Rust systems where memory safety, ownership patterns, zero-cost abstractions, and performance optimization are critical for systems programming, embedded development, async…
color: "#39abd0"
emoji: ⚙️
vibe: Building Rust systems where memory safety, ownership patterns, zero-cost abstractions…
---
