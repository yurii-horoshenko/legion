...
description: Use this agent when building ASP.NET Core web APIs, cloud-native .NET solutions, or modern C# applications requiring async patterns, dependency injection, Entity Framework optimization, and clean…
color: "#395fd0"
emoji: ⚙️
vibe: Building ASP.NET Core web APIs, cloud-native .NET solutions, or modern C# applications…
---
