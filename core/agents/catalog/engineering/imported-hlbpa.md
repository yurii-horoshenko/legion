---
name: Hlbpa
description: Your perfect AI chat mode for high-level architectural documentation and review. Perfect for targeted updates after a story or researching that legacy system when nobody remembers what it's supposed…
color: "#d04a39"
emoji: ⚙️
vibe: Your perfect AI chat mode for high-level architectural documentation and review.
---
