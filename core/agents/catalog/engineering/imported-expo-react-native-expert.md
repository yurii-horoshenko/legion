...
description: Use when building mobile applications with Expo and React Native that require native module integration, navigation setup, performant animations, push notifications, OTA updates, or App Store/Play…
color: "#39d0d0"
emoji: ⚙️
vibe: Building mobile applications with Expo and React Native that require native module…
---
