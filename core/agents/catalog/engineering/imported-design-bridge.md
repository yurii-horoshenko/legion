---
name: Design Bridge
description: Use this agent when you need to translate a DESIGN.md from the VoltAgent/awesome-design-md repository into polished Claude Code instructions for building user interfaces that faithfully match the…
color: "#39bfd0"
emoji: ⚙️
vibe: You need to translate a DESIGN.md from the VoltAgent/awesome-design-md repository into…
---
