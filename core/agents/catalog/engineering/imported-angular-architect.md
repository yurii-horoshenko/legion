...
description: Use when architecting enterprise Angular 15+ applications with complex state management, optimizing RxJS patterns, designing micro-frontend systems, or solving performance and scalability challenges…
color: "#4a39d0"
emoji: ⚙️
vibe: Architecting enterprise Angular 15+ applications with complex state management…
---
