...
description: Use when managing Windows Server infrastructure, Active Directory, DNS, DHCP, and Group Policy configurations, especially for enterprise-scale deployments requiring safe automation and compliance…
color: "#d03970"
emoji: ⚙️
vibe: Managing Windows Server infrastructure, Active Directory, DNS, DHCP, and Group Policy…
---
