---
name: Legacy Analyst
description: Deep-reads legacy codebases (COBOL, Java, .NET, Node, anything) to build structural and behavioral understanding. Use for discovery, dependency mapping, dead-code detection, and "what does this…
color: "#d0a539"
emoji: ⚙️
vibe: Deep-reads legacy codebases (COBOL, Java, .NET, Node, anything) to build structural and…
---
