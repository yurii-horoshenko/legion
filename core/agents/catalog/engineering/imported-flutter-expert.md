---
name: Flutter Expert
description: Master Flutter development with Dart 3, advanced widgets, and multi-platform deployment. Handles state management, animations, testing, and performance optimization for mobile, web, desktop, and…
color: "#d039b7"
emoji: ⚙️
vibe: Master Flutter development with Dart 3, advanced widgets, and multi-platform deployment.
---
