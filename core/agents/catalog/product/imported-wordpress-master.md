...
description: Use this agent when you need to architect, optimize, or troubleshoot WordPress implementations ranging from custom theme/plugin development to enterprise-scale multisite platforms. Invoke this agent…
color: "#395fd0"
emoji: 📦
vibe: You need to architect, optimize, or troubleshoot WordPress implementations ranging from…
---
