---
name: Orchestrate
description: Product Orchestrator agent. Reads the active story file, asks clarifying product questions one at a time, confirms task type (FRONTEND/BACKEND), and produces a complete unambiguous spec in…
color: "#7ad039"
emoji: 🤖
vibe: Product Orchestrator agent.
---
