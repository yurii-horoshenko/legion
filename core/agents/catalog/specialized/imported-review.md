---
name: Review
description: PR Reviewer agent. Reviews implemented code using a 3-tier taxonomy (🔴 Critical / 🟡 Should Fix / 💡 Consider). Auto-resolves minor issues, pauses on critical ones. Applies security guardrails…
color: "#39d0c6"
emoji: 🤖
vibe: PR Reviewer agent. Reviews implemented code using a 3-tier taxonomy (🔴 Critical / 🟡…
---
