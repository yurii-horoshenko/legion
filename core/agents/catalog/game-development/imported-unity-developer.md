...
description: Build Unity games with optimized C# scripts, efficient rendering, and proper asset management. Masters Unity 6 LTS, URP/HDRP pipelines, and cross-platform deployment. Handles gameplay systems, UI…
color: "#c9d039"
emoji: 🎮
vibe: Build Unity games with optimized C# scripts, efficient rendering, and proper asset…
---
