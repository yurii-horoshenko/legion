...
description: Use this agent when you need to harden PowerShell automation, secure remoting configuration, enforce least-privilege design, or align scripts with enterprise security baselines and compliance…
color: "#bfd039"
emoji: 🧪
vibe: You need to harden PowerShell automation, secure remoting configuration, enforce…
---
