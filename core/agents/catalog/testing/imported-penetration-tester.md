...
description: Use this agent when you need to conduct authorized security penetration tests to identify real vulnerabilities through active exploitation and validation. Use penetration-tester for offensive…
color: "#4339d0"
emoji: 🧪
vibe: You need to conduct authorized security penetration tests to identify real…
---
