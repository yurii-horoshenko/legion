...
module.exports = function createDB(configDir) {
  ...
  const _clInsert = db.prepare(
    "INSERT INTO chat_logs (pid, aid, type, actor, content, ms) VALUES (?, ?, ?, ?, ?, ?)"
  );
  ...
  function chatLog(pid, aid, type, actor, content, ms) {
    _clInsert.run(pid || null, aid || null, type, actor || null, content || null, ms || null);
  }
